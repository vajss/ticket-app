...
document.getElementById("ticketNumber2").innerText = "00" + Math.floor((subtractTime( new Date(), 2, -91).getTime() / 1000) / 63.84);
...
document.getElementById("ticketNumber3").innerText = "00" + (Math.floor((subtractTime( new Date(), 1, -83).getTime() / 1000) / 63.84) + 1);
...
document.getElementById("ticketNumber4").innerText = "00" + Math.floor(((new Date()).getTime() / 1000) / 63.84);
